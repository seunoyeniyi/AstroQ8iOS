...
class WebPaymentViewController: NoBarViewController, WKNavigationDelegate, WKScriptMessageHandler {
...
//    var webPaymentDelegate: WebPaymentDelegate?
    ...
    override func viewDidLoad() {
        ...
        webView.frame = CGRect(x: 0, y: 0, width: containerView.frame.width, height: containerView.frame.height + 100)
