...
class OrderViewController: UIViewController {
    ...
    @IBOutlet var trackingContainer: UIView!
    @IBOutlet var trackingContainerHeightConstraint: NSLayoutConstraint!
    @IBOutlet var trackingProviderLabel: UILabel!
    @IBOutlet var trackingNumberLabel: UILabel!
    @IBOutlet var trackBtn: CustomButton!
    
//    var trackingLink: String = ""
    var trackingAvailable: Bool = false
    ...
    override func viewDidLoad() {
        ...
        self.trackingContainerHeightConstraint.constant = 0
        self.trackingContainer.isHidden = true
...
//                            self.checkout_url += "&hide_elements=div*topbar.topbar, div.joinchat__button"
                    ...
                    self.shippingLbl.attributedText = ("<font size='4' face='Verdana, Geneva, sans-serif'>" + json["shipping_to_display"].stringValue + "</font>").htmlToAttributedString
...
//        webPay.webPaymentDelegate = self
        webPay.comming_from = "order"
        webPay.url = self.checkout_url
        self.presentWithCondition(controller: webPay, animated: true, completion: nil)
    }
...
//            browser.headTitle = "Track Order"
//            browser.url = self.trackingLink
//            self.present(browser, animated: true, completion: nil)
//        } else {
//            self.view.makeToast("Your order is not yet picked!")
//        }
    }
